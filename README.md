...
Для корректной работы проекта (в том числе тестов), необходимо в корневой директирии создать папку 
```
templates
```
в которой необходимо разместить html-шаблоны страниц со следующими названиями:
```
create.html
index.html
detail.html
